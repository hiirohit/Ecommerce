  ...
  return (
    ...
    <div className='flex flex-col gap-2 w-full'>
        ...
        <div className='relative'>
            <ListboxButton 
                className={`relative text-sm font-montserrat py-2 rounded-md border border-slate-700 w-full cursor-default bg-white text-left text-gray-600 sm:text-sm sm:leading-6`}>
