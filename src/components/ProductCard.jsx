...
function ProductCard({
    ...
    const [selectedViewProdeuct, setSelectedViewProduct] = useState("");
  ...
  return (
    <div className='border rounded-lg shrink-x1 overflow-hidden transition-shadow duration-300'>
